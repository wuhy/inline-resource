...
function readInlineFiles(root, files) {
    ...
    if (_.isObject(firstFile) && !_.isRegExp(firstFile)) {
...
Inliner.prototype.addInlineTask = function (item) {
    ...
    if (_.isFunction(item)) {
        ...
        var isAdd = _.isUndefined(enable);
        isAdd || (isAdd = _.isFunction(enable) ? enable.call(this) : enable);
