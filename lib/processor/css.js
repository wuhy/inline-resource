...
function CSSInliner() {
    ...
    this.initInlineTasks([
        {enable: option.img, task: getInlineResourceTask(util.isImg)},
        {enable: option.svg, task: getInlineResourceTask(util.isSvg)},
        {enable: option.font, task: getInlineResourceTask(util.isFont)},
