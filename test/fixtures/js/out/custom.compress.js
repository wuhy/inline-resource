...
var css = ''
    + 'body{width:1200px;margin:0 auto;background:#ccc}.icon{height:50px;width:50px;border:0}';
...
!function(){console.log("Hello %s, country: %s","jack","USA");for(var arr=[1,2,10],sum=0,i=0,len=arr.length;i<len;i++)sum+=arr[i]}();;
